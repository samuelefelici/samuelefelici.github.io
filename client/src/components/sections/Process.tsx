...
const STEP_FROM = [0.18, 0.31, 0.44, 0.57, 0.7];
    ...
    <Scene id="process" heightVh={300}>
      <div className="absolute inset-0 flex items-center pt-16">
        <div className="container mx-auto px-4 md:px-6">
          <div data-from="0.03" data-to="0.92">
            <h2 className="text-3xl md:text-4xl font-bold font-heading mb-16 text-center">Il mio processo di lavoro</h2>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            {steps.map((step, index) => (
              <div key={index} data-from={STEP_FROM[index]} data-to="0.94" className="relative text-center group">
