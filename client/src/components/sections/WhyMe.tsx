...
export function WhyMe() {
  ...
  return (
    <Scene id="about" heightVh={260}>
      {/* fase 1: chi sono */}
      <div data-from="0.03" data-to="0.48" className="absolute inset-0 flex items-center pt-16">
      ...
      <div data-from="0.48" data-to="0.94" className="absolute inset-0 flex items-center pt-16">
