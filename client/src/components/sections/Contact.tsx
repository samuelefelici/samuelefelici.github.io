      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-border/80 bg-background/55 backdrop-blur-xl">
            ...
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center text-center p-8 rounded-lg border border-primary/20 bg-background/55 backdrop-blur-xl" data-testid="form-success">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-border/60 bg-background/55 backdrop-blur-xl p-6" data-testid="form-contact">
